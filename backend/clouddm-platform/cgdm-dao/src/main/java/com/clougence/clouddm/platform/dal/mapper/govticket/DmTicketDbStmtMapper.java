 ...
 */
package com.clougence.clouddm.platform.dal.mapper.govticket;
...
public interface DmTicketDbStmtMapper extends BaseMapper<DmTicketDbStmtDO> {

    List<DmTicketDbStmtDO> queryByTicketId(@Param("ticketId") long ticketId);
