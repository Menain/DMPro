...
public interface PermGroupDal {

    DmPermGroupMapper permGroupMapper();

    DmPermGroupMemberMapper permGroupMemberMapper();

    DmPermGroupResourceMapper permGroupResourceMapper();

    DmPermGroupGrantRecordMapper permGroupGrantRecordMapper();
}
