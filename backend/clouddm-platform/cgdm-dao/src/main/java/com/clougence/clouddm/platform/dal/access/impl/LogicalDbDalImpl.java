...
@Slf4j
@Service
public class LogicalDbDalImpl implements LogicalDbDal {
    ...
    @Override
    public DmLogicalDbMapper logicalDbMapper() {
        return logicalDbMapper;
    }

    @Override
    public DmLogicalDbEnvBindingMapper bindingMapper() {
