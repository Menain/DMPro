...
/**
 * FO for openapi interface B: query statement groups + precheck results by ticket ID.
 */
@Getter
@Setter
public class DbChangeTicketStmtFO {

    @McpField(value = DmMcpI18nKey.F_TICKET_ID_DESC, required = true)
