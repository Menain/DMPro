...
/**
 * FO for openapi interface C: query production release detail by release ID.
 */
@Getter
@Setter
public class DbChangeReleaseDetailFO {

    @McpField(value = DmMcpI18nKey.F_RELEASE_ID_DESC, required = true)
